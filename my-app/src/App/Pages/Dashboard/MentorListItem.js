            ...
            <div className={'card ' + firstName}>
                <div className='card-body mx-4 p-3'>
                    ...
                    <div className='mentor-btn-container'>
                        {this.renderRedirect()}
                        <button onClick={this.setRedirect} className='message-btn'>Message {firstName}</button>
                        <button onClick={(e) => this.removeMentor(firstName, e)} className='remove-btn' >Remove {firstName} From Feed</button>
                    </div>
                </div>
            </div>
        );
